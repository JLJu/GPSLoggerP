# Attention. This is a work in progress. The aim of this release is to provide an enanched release of GPS Logger. As soon of possible will be published a new list of features. To release the new app we need beta testers on the play store!
[Intitial GPS Pro project page on main website](https://www.basicairdata.eu/projects/android/basicairdata-gps-pro/)
[Test our new, unpublished beta pro app! contribute to maintain our free open source app!(https://play.google.com/apps/testing/eu.basicairdata.gpspro)
